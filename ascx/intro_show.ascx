<%@ Control Language="c#" Inherits="com.hujun64.intro_show" CodeFile="intro_show.ascx.cs" %>
...
<div align="center" class="DivContent">
    <table width="600" align="left" cellspacing="0" class="frameIntroTable">
        <asp:Repeater ID="RepeaterIntro" runat="server">
            <ItemTemplate>
                <tbody>
                    <tr>
