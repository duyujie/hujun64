<%@ Control Language="c#" Inherits="com.hujun64.index_cyws" CodeFile="index_cyws.ascx.cs" %>

<table align="left" cellpadding="0" cellspacing="0" class="frameIndexCywsTable">
    <tbody>
        <tr>
    ...
    <asp:Repeater ID="RepeaterIndexCyws" runat="server">
        <ItemTemplate>
            <tbody>
                <tr>
                    <td width="5%">
